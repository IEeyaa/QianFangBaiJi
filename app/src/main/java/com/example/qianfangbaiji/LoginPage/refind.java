...
public class refind extends AppCompatActivity {
    EditText password, mail, checkMail;
    Button back, register, getCheckText;
    TextView find;
    String passwordWord = "", mailWord = "", checkWord = "";
    // 用于存储倒计时的计时器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.refind);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Global.reFindCount(passwordWord, mailWord, checkWord)){
                    Intent intent=new Intent(refind.this, login.class);
                    startActivity(intent);
                }
                else{
                    Toast.makeText(refind.this, "验证码错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
